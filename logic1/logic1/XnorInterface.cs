...
namespace logic1
{
    public partial class XnorInterface : UserControl
    {
        ...
        private void XnorInterface_MouseEnter(object sender, EventArgs e)
        {
            this.BorderStyle = BorderStyle.Fixed3D;
        }

        private void XnorInterface_MouseLeave(object sender, EventArgs e)
        {
